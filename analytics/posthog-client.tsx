...
export function PostHogClient() {
  const { NEXT_PUBLIC_POSTHOG_KEY: key, NEXT_PUBLIC_POSTHOG_HOST: host } = publicEnv;
  if (!key) return null;
  const resolvedHost = host ?? "https://us.i.posthog.com";
  return (
    <>
      <Script
        id="posthog-init"
